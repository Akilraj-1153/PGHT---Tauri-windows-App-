...
function HabitReport({ habit }) {
  ...
  return (
    <div className="habit-report text-center  h-full w-full rounded-xl p-2 overflow-hidden ">
        ...
        <div className='h-1/3 w-full gap-2 flex justify-center items-center flex-col'>
        <div className='flex gap-5 w-full flex justify-center items-center '>
                <h2 className="text-2xl font-bold w-fit ">{habit} Report</h2>
                <div className="text-xl font-bold  border-2 border-blue-500 p-1 rounded-md w-fit text-blue-500  hover:bg-blue-500 hover:text-white">
                <button onClick={()=>deleteHabit(habit)}>Delete</button>
                
          </div>
          <div className="text-xl font-bold  border-2 border-blue-500 p-1 rounded-md w-fit text-blue-500  hover:bg-blue-500 hover:text-white">
                <button onClick={()=>setHabitForReport(null)}>Close</button>
          </div>
            </div>
            <div className="intro-text text-md mb-6  w-full ">
