...
function NavBar() {
  ...
  return (
    ...
    <div className='h-[10vh] bg-white w-full sm:h-[7vh] flex justify-center items-center'>
        <div className='navimg h-full xs:w-[25vh] flex justify-center items-center font-bold'>
          <img className='h-[8vh] p-1  w-auto' src={navlogo} alt="Nav Logo" />
          <h1>PGHT</h1>
        </div>
        <div className='hidden sm:flex font-bold gap-10 text-black  w-full h-full justify-end mr-[5vh] items-center rounded-xl'>
        ...
        <div className='menu xs:w-full sm:w-[10vh] h-full flex justify-end items-center p-2 sm:hidden' onClick={handleNavActive}>
          {isNavActive ? <RiMenuFold2Fill size={35} /> : <RiMenuFoldFill size={35} />}
        </div>

    </div> 
    {isNavActive &&
    <div className=' bg-white h-fit w-full  flex justify-center  p-4 w-full flex flex-col font-bold gap-4 sm:hidden shadow-xl'>
